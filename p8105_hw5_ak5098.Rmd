...
The sample average is only approximately equal to the true value of mu for mu = 4, 5, and 6. This could be because of the mu hat estimates when the null is rejected -- as the effect size increases, the null is more likely to be rejected (as we saw in the previous graph). Therefore, there could be a greater "sample size" of mu hats, and greater sample size means the average of the estimates will be closer to the true mu.
